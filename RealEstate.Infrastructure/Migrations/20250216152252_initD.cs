        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityType = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Apartments_Currencies_CurrencyId",
            ...
            migrationBuilder.CreateTable(
                name: "UserFavoriteApartments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserFavoriteApplicationId = table.Column<int>(type: "int", nullable: false),
                    ApartmentId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavoriteApartments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserFavoriteApartments_Apartments_ApartmentId",
                        column: x => x.ApartmentId,
                        principalTable: "Apartments",
                        principalColumn: "ApartmentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFavoriteApartments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Streets_Subdistricts_SubdistrictId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavoriteApartments_ApartmentId",
                table: "UserFavoriteApartments",
                column: "ApartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_UserFavoriteApartments_UserId",
                table: "UserFavoriteApartments",
                column: "UserId");
        }
